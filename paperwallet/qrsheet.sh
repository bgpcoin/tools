...
cat >> $TMP/walletsheet.html <<EOF
<tr><td><img src="a${c}.png"></td><td><strong>$amount</strong><img src="bgp480.png"></td><td><img src="k${c}.png"></td></tr>
<tr><td class="address">$addr</td><td><img src="bgp480.png"></td><td class="key">$key</td></tr>
EOF
